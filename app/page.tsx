...
const FeatureCard = ({ icon, title, description, delay }:any) => (
    <div className="feature-card p-6 rounded-2xl transition-all transform hover:-translate-y-1 hover:shadow-2xl animate-fade-in-up" style={{ animationDelay: delay }}>
        {icon}
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4 overflow-hidden">
        <main className="w-full max-w-4xl mx-auto text-center">
          ...
          <header className="mb-10 animate-fade-in-up">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-4">
              Ace Your <span className="gradient-text">AWS SAA-C03</span> Exam
            </h1>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
            <Link href={'/aws_saa_test'} className="start-btn group inline-flex items-center justify-center text-white font-bold text-lg py-4 px-10 rounded-lg"
            >
        ...
        <footer className="text-center mt-12 text-gray-500 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <p>&copy; 2025 AWS Exam Prep. All Rights Reserved.</p>
        </footer>
      </div>
    </>
  );
